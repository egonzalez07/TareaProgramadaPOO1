 ...
 * @author Elka
 */
public class InicioParqueo extends javax.swing.JFrame{

    /**
     * Creates new form InicioParqueo
     */
    public InicioParqueo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioParqueo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioParqueo().setVisible(true);
            }
        });
    }
